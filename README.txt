...
For our final iteration, we added functionality in the form of deleting todos, checking off todos, and allowing students to view all todos of a certain class in order of priority level (ranging from 1 to 3). 

Is there anything that you implemented but doesn't currently work?
Nothing that we implemented does not currently work. 

What commands are needed to compile and run your code from the command line (or better yet, provide a script that people can use to run your program!)
In the command line, cd into src, and then run our script:

./script.sh

You will be prompted to enter a command from a possible list of commands. Begin by adding a class, and then create a few todos. Then, you can play around with viewing your current classes and todos, deleting todos, and checking off todos. 
...
What user stories were completed this iteration?
The user is able to add a class and a todo to the planner. The user is also able to view the current list of todos and classes.
...
You will be prompted to enter a list of commands to add classes, todos and view the output. 
__________________________________________________
